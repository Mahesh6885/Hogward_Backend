...
def _project_dict(project: Project) -> dict:
    ...
    return {
        ...
        "domain_id": project.domain_id or (u.domain_id if u else None),
        "domain": {
            "id": project.domain.id if project.domain else (u.domain_id if u else None),
            "name": project.domain.name if project.domain else (u.domain.name if u and u.domain else (project.realm or "AI")),
            "display_name": domain_map.get(project.domain.name if project.domain else (u.domain.name if u and u.domain else (project.realm or "AI")), "Open Innovation" if (project.domain and project.domain.name == "OPEN_INNOVATION") else "AI"),
        },
