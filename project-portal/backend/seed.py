...
OFFICIAL_PROBLEM_STATEMENTS = [
    ...
    # ── Cybersecurity Realm (10) — Verbatim from Official PDF ───────────────
]

from app.services.pdf_import_service import OFFICIAL_CYBER_STATEMENTS
OFFICIAL_PROBLEM_STATEMENTS = OFFICIAL_PROBLEM_STATEMENTS + OFFICIAL_CYBER_STATEMENTS
